...
trait GetServiceTrait
{
     ...
     * @return mixed
     */
    public function getPropertyIfExist($pParentId, $parentId, $id, $property, $defaultValue = null, $options = [])
    {
        return $this->getRepository()->getPropertyIfExist($pParentId, $this->getRepoKey([$parentId, $id, $property]), $defaultValue, $options);
    }
    /**
